                      ...
                      <td className="py-3">
                        <div className="flex items-center justify-end gap-3">
                          <label className="flex items-center gap-1 text-[11px] font-medium text-white/60 cursor-pointer">
                            <input 
                              type="checkbox" 
                              className="cursor-pointer accent-emerald-500 rounded outline-none w-4 h-4 border border-white/20 bg-white/5 transition-all focus:ring-0 focus:outline-none" 
